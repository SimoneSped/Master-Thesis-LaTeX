...
\begin{document}
	...
	\mainmatter{}
    \input{B) Chapters/00_introduction}
    \input{B) Chapters/01_background}
    \input{B) Chapters/02_data}
    \input{B) Chapters/03_methods}
    \input{B) Chapters/04_results}
    \input{B) Chapters/05_discussion}
    \input{B) Chapters/06_conclusions}
