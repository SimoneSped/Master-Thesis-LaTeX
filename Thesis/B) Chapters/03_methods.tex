...
The interstellar medium (ISM) is a complex and dynamic environment, shaped by a broad spectrum of physical processes involving turbulence, gravity, magnetic fields, and stellar feedback. These processes give rise to structures across a wide range of scales—from compact molecular cores to extended filaments and bubbles—producing highly irregular and non-linear geometries.

Observationally, the ISM presents a rich variety of morphologies, particularly in molecular clouds, where the interplay between turbulence and self-gravity leads to intricate patterns. Traditional statistical tools often fall short in fully capturing the spatial complexity of these structures. To address this, the use of topological and morphological descriptors has become increasingly relevant.
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/boundaries.png}
