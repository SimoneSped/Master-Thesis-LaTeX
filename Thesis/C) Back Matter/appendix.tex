...
% simulations global fractal dimension: D = 1 for simple shapes, gets higher the more complex it becomes (non necessaria, testo)
% simulations global fractal dimension: GRF (scale free vs with scale) example (non necessaria, testo)
